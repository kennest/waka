		...
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">
					<img class="img-rounded" alt="Logo" src="images/logo.jpg" height="50">
				</a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown menu-large">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">SOLUTIONS ET SERVICES
							<b class="caret"></b>
						</a>
					...
					<li class="dropdown menu-large">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">ESPACE CLIENT
							<b class="caret"></b>
						</a>
						<ul class="dropdown-menu megamenu row">
	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="http://via.placeholder.com/1900x650" alt="...">
